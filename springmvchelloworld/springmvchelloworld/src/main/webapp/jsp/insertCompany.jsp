						...
						<div class="card-body">
							...
							<form:form class="form" role="form" autocomplete="off" action="/insertCompany" modelAttribute="e1">
								<div class="form-group row">
									...
									<div class="col-lg-8">
										<form:input type="text" class="form-control"  path="company_Name" placeholder="Enter Company Name" required="required"/>
									</div>
								</div>
								<div class="form-group row">
									<label class="col-lg-4 col-form-label form-control-label">CEO:</label>
									<div class="col-lg-8">
										<form:input class="form-control" type="text" path="ceo" placeholder="Enter CEO" required="required"/>
									</div>
								</div>
								<div class="form-group row">
									<label class="col-lg-4 col-form-label form-control-label">Turnover:</label>
									<div class="col-lg-8">
										<form:input class="form-control" type="text" path="turnover" placeholder="Enter Turnover" required="required"/>
									</div>
								</div>
								<div class="form-group row">
									<label class="col-lg-4 col-form-label form-control-label">Board of Directors:</label>
									<div class="col-lg-8">
										<form:input class="form-control" type="text" path="boardOfDirectors" placeholder="Enter Board of Directors" required="required"/>
									</div>
								</div>
								<div class="form-group row">
									...
									<div class="col-lg-8">
    									...
    									<form:select class="form-control" path="sector_id" id="sector_id" required="required">
								...
								<div class="form-group row">
									...
									<div class="col-lg-8">
										<form:input class="form-control" type="text" path="breifwriteup" placeholder="Enter Brief" required="required"/>
									</div>
								</div>
								<div class="form-group row">
									<label class="col-lg-4 col-form-label form-control-label">Stock Code:</label>
									<div class="col-lg-8">
										<form:input class="form-control" type="number" path="stock_Code" placeholder="Enter Stock Code" required="required"/>
									</div>
								</div>
								<div class="form-group row">
